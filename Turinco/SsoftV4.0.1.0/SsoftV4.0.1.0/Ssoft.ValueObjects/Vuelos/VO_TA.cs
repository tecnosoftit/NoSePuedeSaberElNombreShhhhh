...
namespace Ssoft.ValueObjects
{
    public class VO_TA
    {
        ...
        public VO_TA(decimal ta_, decimal impuesto_, string moneda_)
        {
            this.dTA = ta_;
        ...
        public VO_TA(decimal ta_, decimal impuesto_, string moneda_, decimal taCOP_, decimal impuestoCOP_)
        {
            this.dTA = ta_;
            this.dImpuesto = impuesto_;
            this.strMoneda = moneda_;
