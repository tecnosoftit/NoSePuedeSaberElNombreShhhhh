...
<%@ Register Src="../uc/ucErrorBusqueda.ascx" TagName="ucErrorBusqueda" TagPrefix="uc2" %>
    ...
    <body onbeforeunload="ConfirmarCierre()" onunload="ManejadorCierre()" class="textCenter verdana">
        ...
        <form id="form1" runat="server">
            <div class="container textLeft" id="wrap">
                ...
                <uc2:ucErrorBusqueda ID="ucErrorBusqueda" runat="server" />

                <nav class="iblock textCenter">
                    <uc4:ucMenuSuperior ID="ucMenuSuperior" runat="server" />
                </nav>
