<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DetalleUltimahora.aspx.cs" Inherits="Presentacion_DetalleUltimahora" %>
...
<%@ Register Src="../uc/ucDetalleUltimahora.ascx" TagName="ucDetalleUltimahora" TagPrefix="uc2" %>
    ...
    <div class="container textLeft" id="wrap">
        ...
        <div id="main">
            <!-- social -->
			 ...
			 <!-- ENDS social --> 
             <div id="content" >
                <uc2:ucDetalleUltimahora ID="ucDetalleUltimahora" runat="server" />
             </div>
        </div>
    </div>
    <footer>
