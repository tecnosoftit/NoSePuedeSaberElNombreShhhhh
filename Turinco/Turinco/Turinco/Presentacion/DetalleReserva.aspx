...
<%@ Register src="../uc/ucDetalleReserva.ascx" tagname="ucDetalleReserva" tagprefix="uc8" %>
...
<body onbeforeunload="ConfirmarCierre()" onunload="ManejadorCierre()" class="detalleMiCuenta">
        ...
        <div class="container textLeft" id="wrap">
            ...
            <div id="main">
                ...
                <div id="content" style="float:left;">  
                    <uc8:ucDetalleReserva ID="ucDetalleReserva" runat="server" />
                </div>
