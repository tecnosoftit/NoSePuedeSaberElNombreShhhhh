...
<%@ Register Src="../uc/ucCondiciones.ascx" TagName="ucCondiciones" TagPrefix="uc2" %>
<%@ Register Src="../uc/ucEncabezado.ascx" TagName="ucEncabezado" TagPrefix="uc1" %>
...
<head id="Head1" runat="server">
  ...
  m = s.getElementsByTagName(o)[0]; a.async = 1; a.src = g; m.parentNode.insertBefore(a, m)
    ...
    <style type="text/css">
        html, body, form { background:none; padding:0; margin:0; border:0; font-family:Trebuchet MS; }
    </style>
</head>
...
<!-- GTM -->
    ...
    <form id="form1" runat="server">
        <uc2:ucCondiciones ID="UcCondiciones1" runat="server" />
