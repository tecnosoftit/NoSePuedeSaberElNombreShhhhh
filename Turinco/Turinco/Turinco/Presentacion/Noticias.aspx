...
<%@ Register Src="../uc/ucNoticias.ascx" TagName="ucNoticias" TagPrefix="uc2" %>
...
<body onbeforeunload="ConfirmarCierre()" onunload="ManejadorCierre()" id="noticias">
...
<form id="form1" runat="server">
    <div id="wrap" style="background-image:none;">
	    ...
	    <div id="main">
	        <div class="panelCompletoNoticias" style="height:460px;">
                <uc2:ucNoticias ID="ucNoticias" runat="server" />
            </div>
