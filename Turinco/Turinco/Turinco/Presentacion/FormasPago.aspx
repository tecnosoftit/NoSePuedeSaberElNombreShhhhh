...
<%@ Register Src="../uc/ucFormasPago.ascx" TagName="ucFormasPago" TagPrefix="uc4" %>
...
<body onbeforeunload="ConfirmarCierre()" onunload="ManejadorCierre()" id="formasPago">
...
<form id="form1" runat="server">
    <div id="wrap">
        ...
        <nav>
            <uc9:ucMenuSuperior ID="ucMenuSuperior" runat="server" />
        </nav>
        
        <div id="main">
	        <div class="panelCompletoNoticias">
                <uc4:ucFormasPago ID="ucFormasPago" runat="server" />
            </div>
