...
<%@ Register Src="../uc/ucBannerSuperiorOff.ascx" TagName="ucBannerSuperiorOff" TagPrefix="uc4" %>
...
<%@ Register Src="../uc/ucCarroCompras.ascx" TagName="ucCarroCompras" TagPrefix="uc2" %>
...
<form id="form1" runat="server">
    <div id="wrap">
	    <div id="header">
	        ...
	        <div id="divMenuOff" runat="server">
                <uc4:ucBannerSuperiorOff ID="UcBannerSuperiorOff1" runat="server" />
            </div>
    	</div>
        <div id="main">
	      
                <uc2:ucCarroCompras ID="ucCarroCompras" runat="server" />
           
            <uc5:ucMenuInferior ID="ucMenuInferior" runat="server" />
