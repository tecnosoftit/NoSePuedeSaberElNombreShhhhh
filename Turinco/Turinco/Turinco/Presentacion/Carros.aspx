...
<body onbeforeunload="ConfirmarCierre()" onunload="ManejadorCierre()" id="herramientas">
...
<form id="form1" runat="server">
    <div class="container textLeft" id="wrap">
	    ...
	    <div id="main">
			 ...
			 <!-- ENDS social --> 
	        <div id="content" >
                <iframe frameborder="0" height="1200" width="100%" id="rc-frame" scrolling="no" src="http://www.rentalcars.com/affxml/Home.do?affiliateCode=turinco&preflang=es&fts=true&form-bg=28ABE3&primary=EF294C&form-text=fff&scene=14&form-hollow=true">autos</iframe>
            </div>    
	    </div>
    </div>
    <footer>
