...
<%@ Register Src="../uc/ucPoliticasdePrivacidad.ascx" TagName="ucPoliticasdePrivacidad" TagPrefix="uc2" %>
        ...
        <form id="form1" runat="server">
            <div class="container textLeft" id="wrap">
                ...
                <div id="main">
			        ...
			        <!-- ENDS social -->  
                    <div id="content">
	                    <uc2:ucPoliticasdePrivacidad ID="ucPoliticasdePrivacidad" runat="server" />
                    </div>
                </div>
