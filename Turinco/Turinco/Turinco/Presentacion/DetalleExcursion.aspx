...
<%@ Register src="../uc/ucDetalleExcursion.ascx" tagname="ucDetalleExcursion" tagprefix="uc2" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        ...
        <!-- Google Code for Boton Llamada Conversion Page -->
        <script type="text/javascript">
            /* <![CDATA[ */
            var google_conversion_id = 958839417;
            var google_conversion_language = "en";
            var google_conversion_format = "3";
            var google_conversion_color = "ffffff";
            var google_conversion_label = "Bjx_CNe1pwMQ-fSayQM";
        ...
        <noscript>
            <div style="display:inline;">
                <img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/958839417/?label=Bjx_CNe1pwMQ-fSayQM&amp;guid=ON&amp;script=0"/>
            </div>
        </noscript>
    </head>
    ...
    <body onbeforeunload="ConfirmarCierre()" onunload="ManejadorCierre()" class="textCenter verdana">
        ...
        <!-- Google Tag Manager -->
        <noscript>
            <iframe src="//www.googletagmanager.com/ns.html?id=GTM-KX8QZK" height="0" width="0" style="display:none;visibility:hidden">
            </iframe>
        </noscript>
        <script>
            (function (w, d, s, l, i) {
        ...
        <form id="form1" runat="server">
            <div class="container textLeft" id="wrap">
                ...
                <uc2:ucDetalleExcursion ID="ucDetalleExcursion1" runat="server" />
