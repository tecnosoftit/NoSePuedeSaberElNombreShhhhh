...
<%@ Register Src="../uc/ucPreguntasFrecuentes.ascx" TagName="ucPreguntasFrecuentes" TagPrefix="uc2" %>
<%@ Register Src="../uc/ucFormularioContacto.ascx" TagName="ucFormularioContacto" TagPrefix="uc3" %>
...
<body onbeforeunload="ConfirmarCierre()" onunload="ManejadorCierre()" id="servicio">
...
<!-- GTM -->
    ...
    <form id="form1" runat="server">
        <div id="wrap">
            ...
            <div id="main">
                <div class="panelCompletoPlanes">
                    <div class="panelContactoPreguntas">
                        <div class="tituloOfertasIndex">
                            <asp:Label ID="lblTopOfertas" runat="server" Text="SERVICIO AL CLIENTE &raquo;"></asp:Label>
                        </div>
                        <div class="contenidoContactenos">
                            <uc3:ucFormularioContacto ID="ucFormularioContacto" runat="server" />
                        </div>
                    </div>
                    <div class="panelPreguntas">
                        <div class="tituloOfertasServicios">
                            <asp:Label ID="lblServiciosComplementarios" runat="server" Text="PREGUNTAS FRECUENTES &raquo;"></asp:Label>
                        </div>
                        <uc2:ucPreguntasFrecuentes ID="ucPreguntasFrecuentes" runat="server" />
                    </div>
                </div>
