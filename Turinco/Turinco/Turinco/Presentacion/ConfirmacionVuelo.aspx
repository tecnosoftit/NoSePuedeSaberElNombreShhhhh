<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfirmacionVuelo.aspx.cs" Inherits="Presentacion_ConfirmacionVuelo" %>
...
<!-- Google Code for Confirmaci&oacute;n Reserva: Tu Tiquete - Mayo 2012 Conversion Page --> <script type="text/javascript">
...
var google_conversion_label = "mrIGCOfYxgMQ-fSayQM"; var google_conversion_value = 0;
...
<img height="1" width="1" style="border-style:none;" alt="" src="https://www.googleadservices.com/pagead/conversion/958839417/?label=mrIGCOfYxgMQ-fSayQM&amp;guid=ON&amp;script=0"/>
...
<form id="form1" runat="server">
    <div id="wrap">
	    ...
	    <div id="main">
            ...
            <div class="panelBannersConfirmacion">
