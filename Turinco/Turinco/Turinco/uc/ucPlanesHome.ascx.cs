...
public partial class uc_ucPlanesHome : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            csRefere.CargarPlanes(this, Enum_TipoDestino.Todos, true, clsValidaciones.GetKeyOrAdd("ClasificacionHome", "OFR"), 0, clsValidaciones.GetKeyOrAdd("NumplanesHome", "6"), false, "intOrden DESC", false, false, true, null);
        }
    }
