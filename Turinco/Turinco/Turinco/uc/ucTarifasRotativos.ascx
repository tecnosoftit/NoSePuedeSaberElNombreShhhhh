<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucTarifasRotativos.ascx.cs"
    Inherits="uc_ucTarifasRotativos" %>
        ...
        <ajax:UpdatePanel ID="upRotativos" runat="server">
            <ContentTemplate>
                ...
                <div class="cotizadorPlan">
                    <div class="full iblock vigencia">
                    ...
                    <div class="ancho47">
                        <div class="ancho100" style="margin-left: 208px;">   
                            <asp:Label CssClass="labelCotizador" ID="lblTCabinas" runat="server" Text="Cantidad de Habitaciones"></asp:Label>
                                ...
                                <asp:Repeater ID="rptPasajeros" runat="server">                                                                        
                                    <ItemTemplate>
                                        <div class="borderCotizador">
                                            ...
                                            <div class="ancho50" style="display:none;">
                                                <div class="labelCotizador">
                                                    <asp:Label ID="lblTJuniors" runat="server" Text="Junior "></asp:Label>
                                                    <asp:Label ID="Label13" runat="server" Text="(12 a 17 Años)"></asp:Label>
                                                </div>

                                                <asp:DropDownList ID="ddlJuniors" runat="server" CssClass="datoCotizador listaCotizador">
                                            ...
                                            <div class="ancho50" style="margin-left: 214px; width: 69%;">
                                                ...
                                                <asp:DropDownList ID="ddlNinos" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlNinos_Selected" CssClass="datoCotizador listaCotizador">
                                                    <asp:ListItem Text="00" Value="0"></asp:ListItem>
                                                    <asp:ListItem Text="01" Value="1"></asp:ListItem>
                                                    <asp:ListItem Text="02" Value="2"></asp:ListItem>
                                                    <asp:ListItem Text="03" Value="3"></asp:ListItem>
                    ...
                    <asp:Label ID="lblErrorGen" runat="server"  ForeColor="#84021C" style="position: absolute; margin-left: -407px; margin-top: 115px;"></asp:Label>                    
                </div>
                        
                <div class="cotizadorPlan" style="min-height: 168px;border-right: 1px solid #ccc; border-left: 1px solid #ccc; padding-left: 19px; padding-right: 21px; margin-left: -21px;">
                    <asp:Repeater ID="rptCabina" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <div class="filaCotizador">
                                            <div class="celdaBaseCotizador celda15">
                                                ...
                                                <a href='#this' onclick='javascript:SetIdHotelRot("<%# DataBinder.Eval(Container.DataItem, "Codigo")%>");' style="text-decoration: underline; color: blue; font-weight: bold;" >
                                            ...
                                            <div style="float:left; width: 781px;">
                                                <asp:Repeater ID="rptTarifas" runat="server">                                                
                                                    <ItemTemplate>
                                                        <div class="filaCotizador">
                                                            <div class="celdaBaseCotizador celda15" style="font-size: 9px;">
                        ...
                        <FooterTemplate>
                            <div style="float: left; position: relative; display:none;">
                                <input id="btnEnviar" type="button" class="botonEnviarAmigo" runat="server" value="" onclick='javascript:popUp();' />                                        
...
<!-- Detalle Hotel -->
<ajax:ModalPopupExtender ID="MPEEHotelRot" BackgroundCssClass="ui-widget-shadow" DropShadow="false" runat="server" TargetControlID="dummyLink" Drag="false" BehaviorID="MPEEHotelRot" OnOkScript="" OkControlID="btnCerrar2" EnableViewState="true" PopupControlID="PanelHotelRot" />
