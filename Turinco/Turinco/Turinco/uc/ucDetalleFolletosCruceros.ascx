<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucDetalleFolletosCruceros.ascx.cs" Inherits="uc_ucDetalleFolletosCruceros" %>
...
<div class="contenidoNoticiasDetalle">
    ...
    <asp:Repeater runat="server" ID="rptSeccion">
        <ItemTemplate>
            ...
            <a class="Regresar" href="../Presentacion/Cruceros.aspx?tipo=PLN" class="VerMas">
                Ver más promociones
            </a> 
