<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucTarifasToures.ascx.cs"
    Inherits="uc_ucTarifasToures" %>
<div class="panelResultados">
    ...
    <div class="contenidoResultado">
        <%--<ajax:UpdatePanel ID="upRotativos" runat="server" EnableViewStateO="false" ViewStateMode="Enabled">
            <ContentTemplate>--%>
        <!--- Cotizador -->
        ...
        <div class="cotizadorPlan">
                            ...
                            <asp:Repeater ID="rptTarifas" runat="server">
                                <ItemTemplate>
                                    <tr style="color: #000;">
                                        ...
                                        <td style="width: 10%">
                                            <asp:Label ID="lblIdTarifa" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.intIdTarifa") %>'></asp:Label>
                                            <asp:RadioButton ID="rbTarifa" runat="server" OnCheckedChanged="ValidaTarifaSeleccionada"
                                                AutoPostBack="true" />
                                        </td>
                                    </tr>
                                </ItemTemplate>
            ...
            <div style="float: right; position: relative;">
                <asp:Button CssClass="botonReservarPlan" ID="btnReservar" runat="server" Text=""
                    OnCommand="btn_Command" CommandName="Reservar" Visible="false" />
            </div>
        </div>
