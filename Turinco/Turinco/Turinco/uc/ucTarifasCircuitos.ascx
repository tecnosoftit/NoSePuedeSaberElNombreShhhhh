            ...
            <ContentTemplate>
                ...
                <div class="cotizadorPlan">
                    <div class="ancho47 borderRight">
                        <div class="ancho100">
                            <asp:Label CssClass="labelCotizador" ID="lblTDuracionCirc" runat="server" Text="Duración "></asp:Label>
                        ...
                        <div class="ancho100">
                            <asp:Label CssClass="labelCotizador" ID="lblTAnioSalida" runat="server" Text="Año "></asp:Label>
                        ...
                        <div class="ancho100">
                            ...
                            <div style="width:48%; display:inline-block;">
                                <asp:Label CssClass="labelCotizador" ID="lblTDiaSalida" runat="server" Text="Día "></asp:Label>
                                        ...
                                        <div class="borderCotizador">
                                            ...
                                            <div class="ancho50" style="display:none;">
                                                <div class="labelCotizador">
                                                    ...
                                                    <asp:Label ID="Label16" runat="server" Text="(12 a 17 Años)"></asp:Label>                                                                                                     
                                                </div>
